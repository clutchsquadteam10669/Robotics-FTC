...
@TeleOp(name = "whythisexistsidon'tknow", group = "Linear Opmode")
@Disabled

public class POVCustom20178Drive extends LinearOpMode {
    ...
    final double initialleft = 0.00;
    final double initialright = 1.00;
