...
public class HardwarePushbotCustom20178 {
    ...
    public static final double MID_SERVO_Left  =  0.0;
    public static final double MID_SERVO_Right = 1.0;
    public static final double COLOR_SERVO_POS = 0;
    public static final double RACK_AND_PINON  =  0.3;
    public static final double RACK_AND_PINON_REVERSE  =  -0.3;
    final double ARM_FORWARD_POWER = 0.5;
    final double ARM_REVERSE_POWER = -0.5;
    public static final double up = 0;
    public static final double setLeft = 0.76;
    public static final double setRight = 0.24;
    public static final double setColor = 0.62;
    ...
    public void init(HardwareMap ahwMap) {
        ...
        leftArmMotor         = hwMap.dcMotor.get("left arm");
        rightArmMotor        = hwMap.dcMotor.get("right arm");
        ...
        colorServo = hwMap.servo.get("color servo");
        colorServo.setPosition(COLOR_SERVO_POS);
