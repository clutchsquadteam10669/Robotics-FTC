...
public class POVCustom120178 extends LinearOpMode {
    ...
    double Forward = 0.50;
    double ForwardFast = 0.70;
    double Backward = -0.50;
    double BackwardFast = -0.70;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
           ...
           if (gamepad1.dpad_up)
            ...
            {
                robot.leftBackMotor.setPower(ForwardFast);
                robot.leftFrontMotor.setPower(ForwardFast);
                robot.rightFrontMotor.setPower(ForwardFast);
                robot.rightBackMotor.setPower(ForwardFast);
            }
            else if (gamepad1.a)
            {
                robot.leftBackMotor.setPower(BackwardFast);
                robot.leftFrontMotor.setPower(BackwardFast);
                robot.rightFrontMotor.setPower(BackwardFast);
                robot.rightBackMotor.setPower(BackwardFast);
            }
            else
            {
